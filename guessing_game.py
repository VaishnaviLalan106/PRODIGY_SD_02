...
title = tk.Label(root, text="Guess the Number (1–100)", font=("Comic Sans MS", 16, "bold"), bg="#146114")
title.pack(pady=15)
...
guess_btn = create_button(root, "Guess", check_guess, "#146114")
guess_btn.pack(pady=6)
reset_btn = create_button(root, "Reset", reset_game, "#146114")
